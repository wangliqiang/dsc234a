...
<head>
    ...
    <link href="/dsc234a/mobile/public/css/app.css?v=<?=date('Ymd')?>" rel=stylesheet>
    <style>
		.picture-tile ul li{
    ...
    <script>
        window.ROOT_URL = '/dsc234a/mobile/';
        window.PC_URL = '/dsc234a/';
        //首页app下载连接
...
<script type="text/javascript" src="/dsc234a/mobile/public/js/manifest.js?v=<?=date('Ymd')?>"></script>
<script type="text/javascript" src="/dsc234a/mobile/public/js/vendor.js?v=<?=date('Ymd')?>"></script>
<script type="text/javascript" src="/dsc234a/mobile/public/js/app.js?v=<?=date('Ymd')?>"></script>
