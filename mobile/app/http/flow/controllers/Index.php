    ...
    public function actionDone()
    {
        ...
        if (0 < $order['order_amount']) {
            ...
            if (strpos($pay_online, '微信') && (!is_wechat_browser() || empty($_SESSION['openid']))) {
                $pay_online = '<a class="box-flex btn-submit min-two-btn" type="button" href="'.url('user/order/payment',array('pay_name'=>'微信支付1','orderid'=>$order['order_sn'],'totalfee'=>$order['order_amount'],'goodname'=>'订单支付')).'">微信支付</a>';
            }
