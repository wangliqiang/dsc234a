<?php
//zend by 旺旺:dongshaolin2008  禁止倒卖 一经发现停止任何服务
...
function get_floor_ajax_goods($cat_id = 0, $num = 0, $warehouse_id = 0, $area_id = 0, $goods_ids = '')
{
	$leftJoin = '';
	$tag_where = '';
