...
?>
    <a href="<?php echo $this->_var['ad']['ad_link']; ?>" style=" background:url(<?php echo $this->_var['ad']['ad_code']; ?>) center center no-repeat; width:100%; height:<?php echo $this->_var['ad']['ad_height']; ?>px;" target="_blank"></a>
