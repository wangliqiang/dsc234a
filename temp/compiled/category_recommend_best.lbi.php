...
?>
                ...
                <div class="">
                    ...
                    <div class="p-name"><a href="<?php echo $this->_var['goods']['url']; ?>" target="_blank" title="<?php echo $this->_var['goods']['short_style_name']; ?>"><?php echo $this->_var['goods']['short_style_name']; ?></a></div>
